...
function AboutMeComponent() {
  return (
    <div>
      ...
      <p>
        I am self driven, which has allowed me to learn technologies and
      ...
      <p>
        ...
        you get stuck on a problem and then the satisfaction when you are able to solve the problem.
      </p>
    </div>
  );
}
